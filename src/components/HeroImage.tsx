...
const HeroImage = ({ src, alt }: Props) => {
  return (
    <div className="relative group w-64 h-64 sm:w-auto sm:h-auto">
      ...
      <div className="z-30 hidden mdl:inline-block absolute w-52 h-52 lgl:w-80 lgl:h-80 bg-textGreen/20  top-0 left-0 group-hover:bg-transparent duration-150"></div>
    </div>
  );
};
