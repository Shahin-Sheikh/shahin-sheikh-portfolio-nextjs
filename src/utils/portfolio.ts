...
export const experienceSection: ExperienceSectionType = {
  ...
  experiences: [
    ...
    {
      company: 'Morpheus Soft.',
      companyUrl: 'https://morpheussoft.com/',
      role: 'Software Engineer (Front-End)',
      started: 'December 2021',
      upto: 'December 2022',
      tasks: [
        'At Morpheus Soft., I played a key role in crafting innovative digital solutions across sectors like Ecommerce, Food Delivery, and Online Travel Agencies (OTA). My expertise lies in front-end development using ReactJS, NextJS, and TypeScript with UI libraries such as Material UI, Ant Design, PrimeReact, and Formik. Additionally, I have backend experience in C#/.NET, NodeJS, PostgreSQL, and MongoDB.',
        'Engineered a biometric authentication system (PalmID OAuth) using Vite + React, Tailwind CSS, and WebAssembly, enabling users to register and log in with left/right hand palm scans or email OTP—reducing login friction by 40%.',
        'Developed a fully responsive crypto trading platform frontend using HTML, CSS, and JavaScript, emphasizing sleek UI and performance optimization for global users.',
        'Translated creative concepts into tangible, high-performing solutions by collaborating with designers, project managers, and engineers to meet client and stakeholder requirements.',
        'Drove effective engineering leadership through close collaboration, knowledge-sharing sessions, and active mentorship of junior developers.',
      ],
    },
    {
      company: 'Teletalk',
